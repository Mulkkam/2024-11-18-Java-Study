...
implements ActionListener
{
     ...
     public  BoardDetail(ControlPanel cp)
     {
    	 ...
    	 dayLa.setBackground(Color.PINK);
    	 ...
    	 nameLa.setBackground(Color.PINK);
    	 ...
    	 hitLa.setBackground(Color.PINK);
    	 ...
    	 subLa.setBackground(Color.PINK);
