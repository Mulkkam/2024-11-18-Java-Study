 ...
 * 	4. BufferedReader / BufferedOutputReader
...
public class IO_1 {
	...
	public static void main(String[] args) {
		...
		// 탐색기 => 다운로드 / 업로드 
		System.out.println("최종 수정일:"+new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(file.lastModified()));
